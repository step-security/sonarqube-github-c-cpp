...
# Scan your C, C++, and Objective-C code with SonarQube Server
...
jobs:
  sonarqube:
    ...
    - name: Install sonar-scanner and build-wrapper
      uses: step-security/sonarqube-github-c-cpp@v2
...
* You want to analyze code written in a language other than C or C++. Use the [SonarQube GitHub Action for SonarQube Server and Cloud](https://github.com/step-security/sonarqube-scan-action) instead.
